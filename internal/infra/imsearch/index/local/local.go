...
import (
	...
	"github.com/krau/ManyACG/internal/infra/imsearch/ivf"
	...
	"github.com/krau/ManyACG/internal/infra/imsearch/kmodes"
)
...
// Compact merges shard files into invlists.bin (used after repeated AutoBuild).
