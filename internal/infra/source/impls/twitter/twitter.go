...
type Twitter struct {
	cfg       config.SourceTwitterConfig
...
func (t *Twitter) GetArtworkInfo(ctx context.Context, sourceURL string) (*source.FetchedArtwork, error) {
